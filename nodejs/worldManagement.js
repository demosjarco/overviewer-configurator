...
ipcMain.on('updateWorldInfo', (event, worldKey, worldDirections, worldEnabled, renderTypes) => {
	config.updateWorldConfig(worldKey, null, null, worldDirections, worldEnabled, renderTypes);
});